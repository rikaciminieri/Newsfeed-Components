...
function articleMaker ({title, date, firstParagraph, secondParagraph, thirdParagraph}) {
  ...
  articleParent.appendChild(dateP);
  articleParent.appendChild(firstP);
  articleParent.appendChild(secondP);
  articleParent.appendChild(thirdP);
  articleParent.appendChild(span);
...
// const testPanel = articleMaker(testObj);


data.forEach(obj => {
  const articleNode = articleMaker(obj);
